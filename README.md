...
> macOS + Android VPN + ADB，一条命令翻墙。iPhone 也能蹭代理。

## 🤔 这玩意儿干嘛的

人在国内，想上 Google / GitHub / ChatGPT？手机有 VPN（ssr/v2ray/tomvpn 都行），但电脑上没有？

这三个脚本帮你把手机 VPN 共享给 Mac，甚至还能中继给 iPhone。
...
> ⚠️ 下面的 IP 只是示例！填脚本显示的实际 IP。

1. 打开 **设置 → 无线局域网（Wi-Fi）**
2. 点你连的 Wi-Fi 名字右边的 **蓝色 ⓘ**
3. 滑到最下面，找到 **HTTP 代理**
4. 点 **"手动"**
5. 填写：
